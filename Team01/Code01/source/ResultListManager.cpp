...
*/
ResultList ResultListManager::addSynonymAndValues(ResultList* result_list_ptr, SYNONYM_NAME synonym_name, SYNONYM_VALUES_LIST synonym_values) {
...
*/
VALUE_LIST ResultListManager::getSynonymValues(ResultList result_list, SYNONYM_NAME target_synonym) {
...
*/
VALUE_LIST ResultListManager::getTupleValues(ResultList result_list, TUPLE_RETURN_SYNONYMS target_synonyms) {
...
STRING_RESULT ResultListManager::getStringValues(VALUE_LIST result_list) {
...
*/
bool ResultListManager::containsSynonym(ResultList result_list, SYNONYM_NAME synonym_name) {
	return result_list.containsSynonym(synonym_name);
}


// More for debugging
void ResultListManager::printResultListValues(RESULT_LIST result_list) {
...
*/
ResultList ResultListManager::merge(ResultList list1, ResultList list2, PROCESSED_SYNONYMS processed_synonyms, PKB pkb) {
...
*/
ResultList ResultListManager::merge(ResultList list1, ResultList list2) {
...
*/
void ResultListManager::replaceAllAttrRefWithDefaultValue(ResultList& list, PROCESSED_SYNONYMS processed_synonyms, PKB pkb) {
...
SYNONYM_NAME_LIST ResultListManager::getCommonSynonyms(ResultList list1, ResultList list2) {
...
ROW ResultListManager::joinRows(ROW r1, ROW r2) {
	ROW joined_row;
...
bool ResultListManager::sameValuesForTheSameCommonSynonyms(ROW r1, ROW r2, SYNONYM_NAME_LIST common_synonyms) {
...
*/
STRING_RESULT ResultListManager::processReturnResult(SYNONYM_VALUES_LIST raw_results) {
...
*/
SYNONYM_VALUES_LIST ResultListManager::convertIntToStringValues(STMT_NUM_LIST int_list) {
